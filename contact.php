...
<div class="container">
    <a class="float-right" href="home.php"><h4><i class="fas fa-sign-in-alt"></i>HOME</h4></a>
        <font type="monotypecorsiva" color="white"><h1>WELCOME TO PARAS HIMRI HOSPITAL</h1></font>
</div>
...
<font color="blue"> <h1>Contact</h1></font>
  <div class="row">
    <div class="col-md-4">
      <p> Drop a note</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +91 89415151515</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: Paras@mail.com</p>
    </div>
